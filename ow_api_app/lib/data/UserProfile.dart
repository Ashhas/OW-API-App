...
class Ratings {
  ...
  Ratings({Damage damage, Damage support}) {
    this._damage = damage;
  ...
  set damage(Damage damage) => _damage = damage;

  Damage get support => _support;

  set support(Damage support) => _support = support;

  Ratings.fromJson(Map<String, dynamic> json) {
    _damage =
        json['damage'] != null ? new Damage.fromJson(json['damage']) : null;
    _support =
        json['support'] != null ? new Damage.fromJson(json['support']) : null;
  }
...
class Damage {
  ...
  Damage({int level, String rankIcon, String roleIcon}) {
    this._level = level;
