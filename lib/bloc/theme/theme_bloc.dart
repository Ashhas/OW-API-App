...
class ThemeBloc extends Bloc<ThemeEvent, ThemeState> {
  ...
  Stream<ThemeState> _mapThemeLoadStartedEventToState() async* {
    ...
    if (themeDarkMode == null) {
      ...
      yield CurrentThemeState(themeMode: ThemeMode.system, isDarkTheme: themeDarkMode);
    } else if (themeDarkMode == true) {
      yield CurrentThemeState(themeMode: ThemeMode.dark, isDarkTheme: themeDarkMode);
    } else if (themeDarkMode == false) {
      yield CurrentThemeState(themeMode: ThemeMode.light, isDarkTheme: themeDarkMode);
    }
  }
